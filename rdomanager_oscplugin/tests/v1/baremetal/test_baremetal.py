...
from rdomanager_oscplugin.tests.v1.baremetal import fakes as baremetal_fakes
...
class TestImport(baremetal_fakes.TestBaremetal):
...
class TestIntrospectionAll(baremetal_fakes.TestBaremetal):
...
class TestStatusAll(baremetal_fakes.TestBaremetal):
