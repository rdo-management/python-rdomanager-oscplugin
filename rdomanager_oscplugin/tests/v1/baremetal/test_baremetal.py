...
class TestConfigureBaremetalBoot(fakes.TestBaremetal):
    ...
    def test_configure_boot_with_suffix(self, find_resource_mock):
        ...
        arglist = ['--image-kernel', 'bm-deploy-kernel_20150101T100620',
                   '--image-ramdisk', 'bm-deploy-ramdisk_20150101T100620']
        verifylist = [('image_kernel', 'bm-deploy-kernel_20150101T100620'),
                      ('image_ramdisk', 'bm-deploy-ramdisk_20150101T100620')]
