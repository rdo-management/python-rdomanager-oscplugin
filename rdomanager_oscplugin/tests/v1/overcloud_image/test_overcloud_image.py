...
class TestUploadOvercloudImage(TestPluginV1):
    ...
    # @mock.patch('rdomanager_oscplugin.utils.file_checksum')
    # def test_image_changed(self, mock_checksum, mock_find_resource):
    #    mock_find_resource.return_value = mock.Mock(checksum='sdfsdfsdf')
    #    mock_checksum.return_value = 'asdasdasd'
    #    self.assertTrue(self.cmd._image_changed('fooname', 'foofilename'))
    ...
    def test_overcloud_create_images(self, mock_subprocess_call):
        ...
        self.cmd._check_file_exists = mock.Mock(return_value=False)
