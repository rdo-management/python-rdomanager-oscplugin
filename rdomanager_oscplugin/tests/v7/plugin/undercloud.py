...
from rdomanager_oscplugin.tests.v7.test_plugin import TestPluginV7
from rdomanager_oscplugin.v7.plugin import undercloud
...
class TestUndercloudInstall(TestPluginV7):
