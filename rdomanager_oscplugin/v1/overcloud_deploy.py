...
class OvercloudDeploy(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        snmp_password = utils.get_heira_password("snmpd_readonly_user_password")
        parameters['SnmpdReadonlyUserPassword'] = snmp_password
        ...
        utils.make_nodes_available(bm_client)
