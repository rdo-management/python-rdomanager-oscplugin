...
class DeployOvercloud(command.Command):
    ...
    def _update_paramaters(self, args, network_client):
        ...
        neutron_enable_tunnelling = not args.neutron_disable_tunnelling
        ...
        if args.use_tht:
            parameters.update({
                ...
                'NeutronEnableTunnelling': neutron_enable_tunnelling,
            })
        else:
            parameters.update({
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('--neutron-disable-tunnelling',
                            dest='neutron_disable_tunnelling', default=False,
                            action="store_true"),
