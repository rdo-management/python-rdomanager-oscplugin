...
class DeployOvercloud(command.Command):
    ...
    def _update_paramaters(self, args, network_client):
        ...
        snmp_pass = utils.get_hiera_password("snmpd_readonly_user_password")
    ...
    def _heat_deploy(self, stack, template, parameters, env, files):
    ...
    def _deploy_tripleo_heat_templates(self, stack, parsed_args):
        ...
        self._heat_deploy(stack, template, parameters, env, files)
