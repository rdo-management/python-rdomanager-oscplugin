...
class DeployOvercloud(command.Command):
    ...
    def _update_paramaters(self, args, network_client):
        ...
        if args.use_tht:
            parameters.update({
                ...
                'OvercloudBlockStorageFlavor': args.cinder_flavor,
                'OvercloudSwiftStorageFlavor': args.swift_flavor,
                'OvercloudCephStorageFlavor': args.ceph_flavor,
            })
        else:
            parameters.update({
                ...
                'Cinder-Storage-1::Flavor': args.cinder_flavor,
                'Compute-1::Flavor': args.compute_flavor,
                'Controller-1::Flavor': args.control_flavor,
                'Swift-Storage-1::Flavor': args.swift_flavor,
                'Ceph-Storage-1::Flavor': args.ceph_flavor,
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('--ceph-flavor', default='baremetal',
                            help=_("Nova flavor to use for ceph storage "
                                   "nodes."))
        parser.add_argument('--cinder-flavor', default='baremetal',
                            help=_("Nova flavor to use for cinder storage "
                                   "nodes."))
        parser.add_argument('--swift-flavor', default='baremetal',
