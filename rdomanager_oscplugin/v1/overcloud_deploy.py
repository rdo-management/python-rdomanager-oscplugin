...
class DeployPlugin(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        utils.wait_for_hypervisor_stats(clients.compute)
        ...
        with open(os.path.expanduser("overcloud-env.json"), 'w+') as f:
            f.write(json.dumps({
                "parameters": {
        ...
        env = template_utils.process_multiple_environments_and_files(
            [RESOURCE_REGISTRY_PATH, "~/overcloud-env.json"])
