...
class DeployPlugin(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        PARAMETERS['CeilometerPassword'] = passwords['OVERCLOUD_CEILOMETER_PASSWORD']
        PARAMETERS['CeilometerMeteringSecret'] = passwords['OVERCLOUD_CEILOMETER_SECRET']
        PARAMETERS['CinderPassword'] = passwords['OVERCLOUD_CINDER_PASSWORD']
        #PARAMETERS[''] = passwords['OVERCLOUD_DEMO_PASSWORD']
        PARAMETERS['GlancePassword'] = passwords['OVERCLOUD_GLANCE_PASSWORD']
        PARAMETERS['HeatPassword'] = passwords['OVERCLOUD_HEAT_PASSWORD']
        #PARAMETERS[''] = passwords['OVERCLOUD_HEAT_STACK_DOMAIN_PASSWORD']
        ...
        orchestration.stacks.create(
            ...
            template=open(OVERCLOUD_YAML_PATH).read(),
